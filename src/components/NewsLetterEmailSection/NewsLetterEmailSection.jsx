...
const NewsLetterEmailSection = () => {
  ...
  "
            style={{
                backgroundImage: "url('https://netro-store-newdemo46.myshopify.com/cdn/shop/files/1009.jpg?v=1745561995&amp;width=1536&quot')"
            }}
        >
            {/* Overlay */}
...
export default NewsLetterEmailSection;
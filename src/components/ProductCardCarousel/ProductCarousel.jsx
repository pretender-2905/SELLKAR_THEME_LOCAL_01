...
import { CartIcon, SearchIcon } from "@/lib/icons";
...
export default function ProductCarousel({ products, title = "You May Also Like" }) {
          ...
          <div className="overflow-hidden">
            ...
            >
              {Array.from({ length: totalSlides }).map((_, slideIndex) => (
                <div
                  key={slideIndex}
                  className="min-w-full grid grid-cols-2 md:grid-cols-4 gap-6 px-12"
                >

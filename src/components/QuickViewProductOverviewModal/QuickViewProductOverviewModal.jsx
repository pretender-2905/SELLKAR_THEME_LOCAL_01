...
//     >
//       <div
//         className="relative bg-white rounded-lg shadow-2xl w-[95vw] h-[90vh] overflow-hidden"
//         onClick={(e) => e.stopPropagation()}
//       >
//         {/* Close Button */}
//         <button
//           onClick={onClose}
//           className="absolute top-4 right-4 z-10 w-10 h-10 flex items-center justify-center rounded-full bg-white text-black shadow-lg hover:bg-black hover:text-white transition-all duration-300"
//         >
//           <svg
//             className="w-6 h-6"
//             fill="none"
...
//             <div
//               className="w-full aspect-square overflow-hidden rounded-lg border bg-white
//              md:cursor-zoom-in"
...
//             {/* Product Info with Checkbox at Bottom */}
//             <div className="flex flex-col">
//               <ProductInfo product={product} agreedToTerms={agreedToTerms} />

//               {/* Terms and Conditions Checkbox - Right Side */}

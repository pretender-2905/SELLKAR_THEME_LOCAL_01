                  ...
                  <tr key={item.id} className="bg-white shadow-sm rounded-lg">
                    ...
                    <td className="px-4 py-4 text-center">
                      <div className="flex items-center justify-center gap-2 border rounded px-2 py-1">
                        <button onClick={() => dispatch(decrementQuantity(item.id))} className="px-2 text-lg">-</button>
                        <span>{item.quantity}</span>
                        <button onClick={() => dispatch(incrementQuantity(item.id))} className="px-2 text-lg">+</button>
                      </div>
                    </td>

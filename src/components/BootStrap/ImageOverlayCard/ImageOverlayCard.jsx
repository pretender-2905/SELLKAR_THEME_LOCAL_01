...
export default function DynamicImgOverlayCard({
    image,
    title,
    buttonText,
    ...
    return (
        ...
        >
            ...
            <Card.Img src={image} alt={title} style={{ width: "100%", height: "100%", objectFit: "cover" }} />
            ...
            >
                ...
                {title && <Card.Title
                    ...
                    style={{ fontSize: "30px", marginBottom: "12px" }}>{title}</Card.Title>}
                ...
                {buttonText && (
                    <AnimatedButton
                        ...
                        onlyBottomBorder={true} // boolean, not string
                        className="" // add hover styles here
                    />
                )}
            </Card.ImgOverlay>
        </Card>
